...
describe('AssetController', () => {
  ...
  beforeEach(() => {
    ...
    } as jest.Mocked<AssetService>;

    (AssetService as jest.MockedClass<typeof AssetService>).mockImplementation(() => mockAssetService);
  ...
  describe('createAsset', () => {
    it('should create asset successfully', async () => {
      ...
      await assetController.createAsset(mockRequest as Request, mockResponse as Response);
  ...
  describe('getAssetById', () => {
    it('should get asset by ID successfully', async () => {
      ...
      await assetController.getAssetById(mockRequest as Request, mockResponse as Response);
  ...
  describe('listAssets', () => {
    it('should list assets successfully', async () => {
      ...
      await assetController.listAssets(mockRequest as Request, mockResponse as Response);
  ...
  describe('updateAsset', () => {
    it('should update asset successfully', async () => {
      ...
      await assetController.updateAsset(mockRequest as Request, mockResponse as Response);
  ...
  describe('deleteAsset', () => {
    it('should delete asset successfully', async () => {
      ...
      await assetController.deleteAsset(mockRequest as Request, mockResponse as Response);
  ...
  describe('bulkCreateAssets', () => {
    it('should bulk create assets successfully', async () => {
      ...
      await assetController.bulkCreateAssets(mockRequest as Request, mockResponse as Response);
  ...
  describe('getAssetStats', () => {
    it('should get asset statistics successfully', async () => {
      ...
      await assetController.getAssetStats(mockRequest as Request, mockResponse as Response);
