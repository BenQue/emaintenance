...
exports.IdParamSchema = exports.FileUploadSchema = exports.UpdateWorkOrderStatusSchema = exports.AssignWorkOrderSchema = exports.WorkOrderQuerySchema = exports.UpdateWorkOrderSchema = exports.CreateWorkOrderSchema = exports.WorkOrderStatusSchema = exports.PrioritySchema = void 0;
...
exports.CreateWorkOrderSchema = zod_1.z.object({
    ...
    assetId: zod_1.z.string()
        .min(1, '设备ID不能为空'),
    attachments: zod_1.z.array(zod_1.z.string().url('附件路径必须是有效的URL'))
        .max(10, '最多只能上传10个附件')
        .optional()
        .default([]),
});
