...
describe('AssignmentRuleController', () => {
    ...
    beforeEach(() => {
        controller = new AssignmentRuleController_1.AssignmentRuleController(mockPrisma);
        mockRequest = {
            user: { id: userId },
            body: {},
            params: {},
    ...
    describe('createRule', () => {
        ...
        it('should create rule successfully', async () => {
            ...
            await controller.createRule(mockRequest, mockResponse);
    ...
    describe('getRuleById', () => {
        ...
        it('should get rule by id successfully', async () => {
            ...
            await controller.getRuleById(mockRequest, mockResponse);
    ...
    describe('getRules', () => {
        ...
        it('should get rules with pagination', async () => {
            ...
            await controller.getRules(mockRequest, mockResponse);
            expect(mockAssignmentRuleService.getRules).toHaveBeenCalledWith({ page: 1, limit: 10 }, userId);
            expect(mockResponse.json).toHaveBeenCalledWith({
                success: true,
    ...
    describe('updateRule', () => {
        ...
        it('should update rule successfully', async () => {
            ...
            await controller.updateRule(mockRequest, mockResponse);
            expect(mockAssignmentRuleService.updateRule).toHaveBeenCalledWith(ruleId, updateData, userId);
            expect(mockResponse.json).toHaveBeenCalledWith({
                success: true,
    ...
    describe('deleteRule', () => {
        ...
        it('should delete rule successfully', async () => {
            ...
            mockRequest.params = { id: ruleId };
            await controller.deleteRule(mockRequest, mockResponse);
