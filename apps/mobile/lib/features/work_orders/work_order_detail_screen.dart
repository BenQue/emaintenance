...
class _WorkOrderDetailScreenState extends State<WorkOrderDetailScreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFaultSymptomsRow(workOrder.faultSymptoms),
  ...
  Widget _buildFaultSymptomsRow(List<FaultSymptom> faultSymptoms) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          if (faultSymptoms.isEmpty)
            const Text('无', style: TextStyle(color: Colors.grey))
          else
            Wrap(
              spacing: 6,
              runSpacing: 4,
